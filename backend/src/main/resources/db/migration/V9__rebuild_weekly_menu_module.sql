...
CREATE TABLE menu_week_items (
    ...
    dish_items_json TEXT,
    total_calories INT,
    meal_name VARCHAR(128),
    meal_detail VARCHAR(255),
    calories INT,
    merchant_note VARCHAR(128),
    image_url VARCHAR(255),
    sort_order INT NOT NULL DEFAULT 0,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT uq_menu_week_slot UNIQUE (week_id, serve_date, meal_period)
);
...
VALUES
    ...
    (1, DATE '2026-05-13', 3, 'LUNCH', 'ACTIVE', '["避风塘大虾","西葫芦香炒蛋","炝炒上海青","白米饭"]', 528, '避风塘大虾+西葫芦香炒蛋+炝炒上海青+白米饭', '避风塘大虾+西葫芦香炒蛋+炝炒上海青+白米饭', 528, '', '/assets/meal-default.jpeg', 1),
    ...
    (1, DATE '2026-05-15', 5, 'DINNER', 'ACTIVE', '["广东白切鸡","番茄烘蛋","酸辣土豆丝","藜麦饭"]', 558, '广东白切鸡+番茄烘蛋+酸辣土豆丝+藜麦饭', '广东白切鸡+番茄烘蛋+酸辣土豆丝+藜麦饭', 558, '', '/assets/meal-default.jpeg', 2),
