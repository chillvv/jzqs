...
public class RiderController {
    ...
    public ApiResponse<RiderAddressReferenceBatchSaveResponse> saveBatchAddressReferenceImage(
        @RequestAttribute(value = "riderName", required = false) String riderName,
        @RequestAttribute(value = "riderId", required = false) Long riderId,
    ...
    public ApiResponse<RiderAddressReferenceReplaceResponse> replaceAddressReferenceImage(
        @Parameter(description = "地址记录ID", required = true)
    ...
    public ApiResponse<DeliveryReceiptRecordResponse> completeOrder(
    ...
    public ApiResponse<RiderOrderStatusRevertResponse> revertOrder(
        @Parameter(description = "订单ID", required = true)
        @PathVariable long orderId,
        @RequestAttribute(value = "riderName", required = false) String riderName,
        @RequestAttribute(value = "riderId", required = false) Long riderId
    ...
    public ApiResponse<RiderQueueReorderResponse> reorderOrders(
        @RequestAttribute(value = "riderName", required = false) String riderName,
        @RequestAttribute(value = "riderId", required = false) Long riderId,
    ...
    public ApiResponse<DeliveryReceiptDeleteResponse> deleteReceiptImage(
        @Parameter(description = "订单ID", required = true)
        @PathVariable long orderId,
        @RequestAttribute(value = "riderName", required = false) String riderName,
        @RequestAttribute(value = "riderId", required = false) Long riderId
