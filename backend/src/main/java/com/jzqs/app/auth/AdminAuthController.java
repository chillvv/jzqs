...
public class AdminAuthController {
    ...
    public ApiResponse<AdminAuthActionResponse> changePassword(
    ...
    @PostMapping("/logout")
    public ApiResponse<AdminAuthActionResponse> logout(@RequestHeader("Authorization") String authorization) {
