...
public class AuthService {
    ...
    private AuthLoginResponse customerLogin(String openid) {
        ...
        // 生成 token
        String token = JwtUtils.generateToken(JwtClaims.customer(customerId, openid));
    ...
    private AuthBindPhoneResponse buildCustomerAuthResponse(Long customerId, String phone) {
        // 生成 token
        String token = JwtUtils.generateToken(JwtClaims.customer(customerId, null));
    ...
    private AuthBindPhoneResponse bindRiderPhone(String phone) {
        ...
        return buildRiderAuthResponse(
            ...
            phone,
            rider.riderName(),
            mapRiderStatus(rider.authStatus())
        );
    }
    ...
    private RiderInfo getRiderInfo(Long riderId) {
        return jdbcTemplate.query(
    ...
    private record RiderInfo(long riderId, String riderName, String phone, String authStatus) {
    }
