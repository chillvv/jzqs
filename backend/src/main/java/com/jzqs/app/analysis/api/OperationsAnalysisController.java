...
public class OperationsAnalysisController {
    ...
    public ApiResponse<Map<String, Object>> createCostEntry(@RequestBody Map<String, Object> body) {
        return ApiResponse.success(operationsAnalysisService.createCostEntry(body));
    }
}
