...
public class AftersaleServiceImpl implements AftersaleService {
    ...
    @Override
    @Transactional
    public AdminAftersaleCreateResponse createCase(AdminAftersaleCreateRequest request) {
    ...
    @Override
    @Transactional
    public MobileCreateAfterSaleResponse createMobileCase(long customerId, long orderId, MobileCreateAfterSaleRequest request) {
        ...
        if (autoRefund) {
            ...
            return new MobileCreateAfterSaleResponse(caseId, "COMPLETED");
        }
        return new MobileCreateAfterSaleResponse(caseId, "PENDING");
    }

    @Override
    @Transactional
    public AdminAftersaleResolveResponse resolveCase(long caseId, AdminAftersaleResolveRequest request) {
        ...
        if ("COMPLETED".equals(existingCase.status()) || "REJECTED".equals(existingCase.status())) {
            return new AdminAftersaleResolveResponse(caseId, existingCase.status(), existingCase.resolutionAction());
        }
        ...
        if ("REJECT".equals(action)) {
            ...
            return new AdminAftersaleResolveResponse(caseId, "REJECTED", "REJECT");
        }
        ...
        if ("REFUND_TO_WALLET".equals(action)) {
            ...
            return new AdminAftersaleResolveResponse(caseId, "COMPLETED", "REFUND_TO_WALLET");
        }
        ...
        return new AdminAftersaleResolveResponse(caseId, "COMPLETED", action);
    }
