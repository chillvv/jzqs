...
public record WalletAdjustRequest(
    ...
    public WalletAdjustRequest(int mealDelta, Integer validityDays, String operatorName, String remark) {
        this(mealDelta, validityDays, operatorName, null, remark, null);
    }

    public WalletAdjustRequest(int mealDelta, Integer validityDays, String operatorName, String remark, String expiredAt) {
        this(mealDelta, validityDays, operatorName, null, remark, expiredAt);
    }
}
