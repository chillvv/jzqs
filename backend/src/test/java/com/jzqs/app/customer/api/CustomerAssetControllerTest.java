...
class CustomerAssetControllerTest {
    ...
    void shouldCreateCustomerAddress() throws Exception {
        given(customerAssetService.createCustomerAddress(1L, Map.of(
            "contactName", "前台",
    ...
    void shouldUpdateCustomerAddress() throws Exception {
        given(customerAssetService.updateCustomerAddress(1L, 12L, Map.of(
            "contactName", "前台",
    ...
    void shouldDeleteCustomerAddress() throws Exception {
        given(customerAssetService.deleteCustomerAddress(1L, 12L)).willReturn(Map.of(
            "customerId", 1L,
            "addressId", 12L,
            "status", "DELETED"
        ));
    ...
    void shouldDeductWalletMealsWithoutValidityDays() throws Exception {
        WalletAdjustRequest request = new WalletAdjustRequest(1, null, "后台客服", "手工扣减");
        given(customerAssetService.deductMeals(1L, request)).willReturn(Map.of(
            "customerId", 1L,
            "remainingMeals", 8,
            "status", "UPDATED"
        ));
