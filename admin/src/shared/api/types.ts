...
export type DispatchAiJobLogResponse = {
  id: number;
  runType: string;
  triggerSource: string;
  serveDate: string;
...
export type DispatchRouteLabStartResponse = {
  logId: number;
  status: string;
  message: string;
};

export type DispatchAiWorkbenchResponse = {
  settings: DispatchAiSettingsResponse;
  recentLogs: DispatchAiJobLogResponse[];
};

export type DispatchAreaAiCorrectionPreviewResponse = {
  correctionId: number;
...
export type DispatchAreaMemoryItem = {
  id: number;
  memoryType: string;
  title: string;
  summary: string;
...
export type DispatchAreaCodeListResponse = {
  areaCodes: string[];
};

export type DispatchAreaMemoryListResponse = {
  areaCode: string;
  items: DispatchAreaMemoryItem[];
};

export type DispatchAreaMemorySourceListResponse = {
  areaCode: string;
  memoryId: number;
  memoryTitle: string;
  items: Array<{
...
export type DispatchAiRunNowResponse = {
  serveDate: string;
  mealPeriod: string;
  scannedAreaCount: number;
  successCount: number;
  failedCount: number;
  message: string;
};
