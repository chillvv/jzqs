...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "settings", element: <Suspense fallback={<PageFallback />}><SystemSettingsPage /></Suspense> },
      { path: "maintenance", element: <Suspense fallback={<PageFallback />}><MaintenancePage /></Suspense> }
    ]
  }
]);
