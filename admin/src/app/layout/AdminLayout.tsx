...
const items = [
  ...
  { key: "/orders", label: "每日运营台", shortLabel: "运营", description: "备餐、固定订餐、订单处理", icon: <ClipboardList size={18} /> },
  { key: "/aftersales", label: "统一售后中心", shortLabel: "售后", description: "退款、异常、补偿处理", icon: <LifeBuoy size={18} /> },
  { key: "/dispatch", label: "骑手配送中心", shortLabel: "配送", description: "派单、轨迹、回执与通知", icon: <Bike size={18} /> },
