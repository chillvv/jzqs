            ...
            <div className="modal-body">
              <div className="form-group" style={{ display: "flex", gap: 16 }}>
                <div style={{ flex: 1 }}>
                  ...
                  <SafeInput type="date" className="form-control" value={costForm.costDate} onValueChange={(value) => setCostForm({ ...costForm, costDate: value })} />
                </div>
                <div style={{ flex: 1 }}>
                  <label className="form-label"><span className="required">*</span>支出金额 (元)</label>
                  <SafeInput type="number" step="0.01" min="0" className="form-control" placeholder="0.00" value={costForm.amount} onValueChange={(value) => setCostForm({ ...costForm, amount: value })} />
                </div>
              </div>
