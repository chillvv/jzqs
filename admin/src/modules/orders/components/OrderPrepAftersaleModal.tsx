    ...
    <div className="modal-overlay">
      <div className="modal-content" style={{ maxWidth: "680px" }}>
        <div className="modal-header">
          <span>售后处理 - {activeItem.customerName}</span>
          <button type="button" className="modal-close" disabled={submittingOrderAftersale} onClick={submittingOrderAftersale ? undefined : onClose}><X size={20} /></button>
        </div>
        ...
        <div className="modal-footer">
          <button className="btn btn-outline" onClick={onClose} disabled={submittingOrderAftersale}>取消</button>
          <button
