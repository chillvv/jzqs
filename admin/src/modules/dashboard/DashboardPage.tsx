...
export function DashboardPage() {
  ...
  const orderLinePath = buildLinePath(orderValues, 760, 280, 72, 40, 48);
  const orderAreaPath = buildAreaPath(orderValues, 760, 280, 72, 40, 48);
  const lunchLinePath = buildLinePath(lunchValues, 760, 280, 72, 40, 48);
  const dinnerLinePath = buildLinePath(dinnerValues, 760, 280, 72, 40, 48);
  ...
  const orderPeakY = 40 + (192 - (orderSummary.peakValue / orderMax) * 192);
          ...
          <section className="table-container dashboard-bi__panel dashboard-bi__panel--chart">
            ...
            <div className="dashboard-bi__chart-wrap">
              <svg className="dashboard-bi__chart-svg" viewBox="0 0 760 280" role="img" aria-label="订单趋势图">
                ...
                {[1, 2, 3].map((tick) => {
                  const y = 40 + (192 / 4) * tick;
                  return <line key={tick} x1="72" y1={y} x2="688" y2={y} stroke="rgba(0, 0, 0, 0.03)" strokeDasharray="4 8" />;
                })}
                <line x1="72" y1="40" x2="72" y2="232" stroke="rgba(0, 0, 0, 0.03)" />
                <line x1="72" y1="232" x2="688" y2="232" stroke="rgba(0, 0, 0, 0.03)" />
            ...
            <div className="dashboard-bi__chart-wrap">
              <svg className="dashboard-bi__chart-svg dashboard-bi__chart-svg--compact" viewBox="0 0 420 280" role="img" aria-label="开卡续卡趋势图">
                {[1, 2, 3].map((tick) => {
                  ...
                  return <line key={tick} x1="48" y1={y} x2="380" y2={y} stroke="rgba(0, 0, 0, 0.03)" strokeDasharray="4 8" />;
                })}
                <line x1="48" y1="28" x2="48" y2="246" stroke="rgba(0, 0, 0, 0.03)" />
                <line x1="48" y1="246" x2="380" y2="246" stroke="rgba(0, 0, 0, 0.03)" />
