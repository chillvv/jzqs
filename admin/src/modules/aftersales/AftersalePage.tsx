...
export function AftersalePage() {
  ...
  const aftersaleListStatus: AsyncContentViewStatus = loading
    ? "loading"
    : error
      ? "error"
      ...
      <div className="stat-row">
        ...
        {tabs.map((tab) => (
          <button
            ...
            style={{
              textAlign: "left",
              opacity: viewMode === "settlement" ? 1 : 0.92,
        ...
        {selectedIds.size > 0 && (
          <div className="table-bulk-bar">
            <div className="table-bulk-bar__left">
              <span className="table-bulk-bar__count">已选 {selectedIds.size} 项</span>
            </div>
            <div className="table-bulk-bar__actions">
              <button className="btn btn-outline btn-compact" onClick={() => setSelectedIds(new Set())}>取消选中</button>
              <button className="btn btn-primary btn-compact" onClick={() => toast("批量处理功能开发中")}>批量处理</button>
            </div>
          </div>
        )}

        {aftersaleListStatus !== "success" ? (
          <AsyncContentView
            status={aftersaleListStatus}
            error={error ?? undefined}
            emptyText="当前筛选条件下没有售后记录"
          />
        ) : (
          <>
            ...
            <div className="modal-body" style={{ display: "grid", gap: "18px" }}>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <SafeTextarea
                  ...
                  onValueChange={(value) => setCreateForm((current) => ({ ...current, reasonText: value }))}
                  rows={3}
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <SafeInput
                  ...
                  onValueChange={(value) => setCreateForm((current) => ({ ...current, issueParamSummary: value }))}
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <SafeInput
                  ...
                  onValueChange={(value) => setCreateForm((current) => ({
                    ...current,
                    estimatedLossMeals: Math.max(0, Number(value) || 0)
                  }))}
                />
              </div>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <SafeTextarea
                  ...
                  onValueChange={(value) => setCreateForm((current) => ({ ...current, remark: value }))}
                  rows={3}
            ...
            <div className="modal-body" style={{ display: "grid", gap: "18px" }}>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}>
                ...
                <SafeTextarea
                  ...
                  onValueChange={(value) => setResolveForm((current) => ({ ...current, adminRemark: value }))}
