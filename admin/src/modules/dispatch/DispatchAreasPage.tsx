    ...
    <div className="admin-stack">
      ...
      >
        <label className="admin-field">
          ...
          <SafeInput
            className={createAreaNameError ? "admin-input admin-input--error" : "admin-input"}
            value={newArea.name}
            onValueChange={(value) => {
            ...
            style={{
              ...inputStyle,
              border: createAreaNameError ? "1px solid var(--error-color-dark)" : inputStyle.border
            }}
          />
      ...
      >
        <label className="admin-field">
          ...
          <SafeInput value={renameValue} onValueChange={setRenameValue} style={inputStyle} autoFocus />
        </label>
      </AdminDialog>
